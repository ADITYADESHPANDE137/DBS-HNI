...
CREATE TABLE WORK_MANAGER(WORK_MANAGER_ID INT PRIMARY KEY,WORK_MANAGER_NAME VARCHAR(20),BANK_ID INT,
FOREIGN KEY(WORK_MANAGER_ID) REFERENCES BANKING_INFO(BANK_ID) ON DELETE SET NULL);
